...
// --- MOCK COMPONENTS & HOOKS FOR STANDALONE PREVIEW ---
// In a real app, you would import these from 'react-router-dom'.
                    ...
                    <div className="bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl px-8 pt-10 pb-8">
                        ...
                        {success ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    <button type="submit" disabled={loading} className="w-full bg-gray-800 hover:bg-black text-white text-sm font-semibold py-3 rounded-lg transition duration-200 disabled:opacity-50">
